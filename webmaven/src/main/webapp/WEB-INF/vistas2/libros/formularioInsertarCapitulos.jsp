	...
	${libro_titulo}		Nuevo <span class="glyphicon glyphicon-list-alt"></span>
		...
		<form action="ServletControladorFrontal">
			...
			<div class='row'>
				...
				<div class='col-xs-4'>
					...
					<br> <input type="submit" value="Guardar"
						...
						<a href="ServletControladorFrontal?accion=envioLibro&libro_titulo=${libro_titulo}" class='colorNuevo marginSalir'><span
			...
			<input type="hidden" name="libro_titulo"
				value="${libro_titulo}"/> <input
				type="hidden" name="accion" value="insertarCapitulo" />
